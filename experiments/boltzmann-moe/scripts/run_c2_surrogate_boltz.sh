#!/bin/bash
# c2-surrogate_boltz: SurrogateBoltzmannMoE (iso-param B5 + linear surrogate router)

set -euo pipefail
REPO=/proj/dmfexp/nima/Code/dolomite-engine
CONFIG=${REPO}/configs/multi_block_ablation/c2_surrogate_boltz_16x1024_d768.yml
SAVE_PATH=${REPO}/experiments/boltzmann-moe/results/c2_surrogate_boltz_16x1024_d768
SCRIPT_PATH=${REPO}/experiments/boltzmann-moe/scripts/run_c2_surrogate_boltz.sh
JOB_NAME=c2-surrogate_boltz_d768
