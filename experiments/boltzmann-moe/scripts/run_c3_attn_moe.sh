#!/bin/bash
# c3-attn_moe: BoltzmannMoE_Energy_Attention (2 attn experts)

set -euo pipefail
REPO=/proj/dmfexp/nima/Code/dolomite-engine
CONFIG=${REPO}/configs/multi_block_ablation/c3_attn_moe_2x_d768.yml
SAVE_PATH=${REPO}/experiments/boltzmann-moe/results/c3_attn_moe_2x_d768
SCRIPT_PATH=${REPO}/experiments/boltzmann-moe/scripts/run_c3_attn_moe.sh
JOB_NAME=c3-attn_moe_d768
