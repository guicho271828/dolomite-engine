...
\begin{figure}[h]
  ...
  \caption{Cosine-similarity regulariser performance (176M, 30k steps). V39 act-cosreg and V48 wt-cosreg ($\lambda{=}0.01$) impose minimal accuracy overhead vs V0 GPT and V1 EGPT.}
