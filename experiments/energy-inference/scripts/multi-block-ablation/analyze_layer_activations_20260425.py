...
def main():
    ...
    if models_12:
        ...
        for label, data in models_12.items():
            ...
            axes[0].plot(x, data["successive"],          color=color, linewidth=2, marker="o", markersize=4,
                         label=label.replace("\n", " "))
            axes[0].plot(x, data["rand_succ"],           color=color, linewidth=1.2, linestyle=":", marker="s", markersize=3)
            axes[1].plot(x, data["seq_delta_succ"],      color=color, linewidth=2, marker="o", markersize=4,
                         label=label.replace("\n", " "))
            axes[1].plot(x, data["rand_seq_delta_succ"], color=color, linewidth=1.2, linestyle=":", marker="s", markersize=3)
            axes[2].plot(x, data["same_delta_succ"],     color=color, linewidth=2, marker="o", markersize=4,
                         label=label.replace("\n", " "))
            axes[2].plot(x, data["rand_same_delta_succ"],color=color, linewidth=1.2, linestyle=":", marker="s", markersize=3)
        titles = [
