...
MODELS = {
    "V0 GPT\n12×1": {
        ...
        "color": "#4477AA", "n_layers": 12, "arch": "GPT", "linestyle": "-", "marker": "s",
    },
    "V1 EGPT\n12×1": {
        "path": BASE / "v1_12x1_d768_lr2e3" / "unsharded",
        "color": "#EE6677", "n_layers": 12, "arch": "EGPT", "linestyle": "-", "marker": "o",
    },
    "V39 EGPT\n+act-cosreg": {
        "path": BASE / "v39_egpt_cosreg_12x1_d768_lr2e3" / "unsharded",
        "color": "#AA3377", "n_layers": 12, "arch": "EGPT+cosreg", "linestyle": "--", "marker": "o",
    },
    "V41 Sandwich\n2G+8E+2G": {
        "path": BASE / "v41_sandwich_2gpt8e2gpt_d768_lr2e3" / "unsharded",
        "color": "#228833", "n_layers": 12, "arch": "Sandwich", "linestyle": "-.", "marker": "^",
    },
    "V42 Naive\n+5k FT": {
        "path": BASE / "v42_egpt_6layer_naive_merge_finetune_d768" / "unsharded",
        "color": "#EE8800", "n_layers": 6, "arch": "Merged+FT", "linestyle": "-", "marker": "o",
    },
    "V43 Procrustes\n+5k FT": {
        "path": BASE / "v43_egpt_6layer_procrustes_merge_finetune_d768" / "unsharded",
        "color": "#0077BB", "n_layers": 6, "arch": "Merged+FT", "linestyle": "-", "marker": "D",
    },
}
...
def plot_successive_proj(all_results):
    ...
    for ax, (label, data) in zip(axes, all_results.items()):
        ...
        mkr   = info.get("marker", "o")
        x     = np.arange(len(data["full_succ"]))

        ax.plot(x, data["full_succ"],     color=color, lw=2.5, marker=mkr, ms=6, ls=ls,
                label="Full block Δ")
        ax.plot(x, data["attn_raw_succ"], color=color, lw=1.8, marker=mkr, ms=4, ls=ls, alpha=0.7,
                label="Attn raw")
        ...
        ax.plot(x, data["ffn_raw_succ"],  color="gray", lw=1.4, marker=mkr, ms=3, ls=ls, alpha=0.5,
                label="FFN raw")
