#!/bin/bash
# V14: V14: Mixed-head attention 10E+2G (12×1) — 10 energy heads (V=K) + 2 GPT heads per block

set -euo pipefail
REPO=/proj/dmfexp/nima/Code/dolomite-engine
CONFIG=/proj/dmfexp/nima/Code/dolomite-engine/configs/multi_block_ablation/v14_mixed_10e2g_12x1_d768_lr2e3.yml
SAVE_PATH=/proj/dmfexp/nima/Code/dolomite-engine/experiments/energy-inference/results/multi-block-ablation/v14_mixed_10e2g_12x1_d768_lr2e3
SCRIPT_PATH=/proj/dmfexp/nima/Code/dolomite-engine/experiments/energy-inference/scripts/multi-block-ablation/run_v14_mixed_10e2g_12x1_d768_lr2e3.sh
JOB_NAME=egpt_v14_10e2g
...
if [ -f "\${LATEST_JSON}" ]; then
    ...
    TMPCONFIG="/tmp/v14_resume_\${LSB_JOBID}.yml"
    cp "\${CONFIG}" "\${TMPCONFIG}"
...
[ -f "/tmp/v14_resume_\${LSB_JOBID}.yml" ] && rm -f "/tmp/v14_resume_\${LSB_JOBID}.yml"
