#!/bin/bash
# V16: V16: Energy-descent mixed heads (12×1) — mixed_head_attention (6E+6G) with energy descent update rule

set -euo pipefail
REPO=/proj/dmfexp/nima/Code/dolomite-engine
CONFIG=/proj/dmfexp/nima/Code/dolomite-engine/configs/multi_block_ablation/v16_mixed_energy_descent_12x1_d768_lr2e3.yml
SAVE_PATH=/proj/dmfexp/nima/Code/dolomite-engine/experiments/energy-inference/results/multi-block-ablation/v16_mixed_energy_descent_12x1_d768_lr2e3
SCRIPT_PATH=/proj/dmfexp/nima/Code/dolomite-engine/experiments/energy-inference/scripts/multi-block-ablation/run_v16_mixed_energy_descent_12x1_d768_lr2e3.sh
JOB_NAME=egpt_v16_edesc
...
if [ -f "\${LATEST_JSON}" ]; then
    ...
    TMPCONFIG="/tmp/v16_resume_\${LSB_JOBID}.yml"
    cp "\${CONFIG}" "\${TMPCONFIG}"
...
[ -f "/tmp/v16_resume_\${LSB_JOBID}.yml" ] && rm -f "/tmp/v16_resume_\${LSB_JOBID}.yml"
