#!/bin/bash
# v27_egrad_attn_12x1_d768_lr2e3: true EGrad/EDesc run (config bug fixed)

set -euo pipefail
REPO=/proj/dmfexp/nima/Code/dolomite-engine
CONFIG=/proj/dmfexp/nima/Code/dolomite-engine/configs/multi_block_ablation/v27_egrad_attn_12x1_d768_lr2e3.yml
SAVE_PATH=/proj/dmfexp/nima/Code/dolomite-engine/experiments/energy-inference/results/multi-block-ablation/v27_egrad_attn_12x1_d768_lr2e3
SCRIPT_PATH=/proj/dmfexp/nima/Code/dolomite-engine/experiments/energy-inference/scripts/multi-block-ablation/run_v27_egrad_attn_12x1_d768_lr2e3.sh
JOB_NAME=egptv27
...
if [ -f "\${LATEST_JSON}" ]; then
    ...
    TMPCONFIG="/tmp/v27_egrad_attn_12x1_d768_lr2e3_resume_\${LSB_JOBID}.yml"
    cp "\${CONFIG}" "\${TMPCONFIG}"
...
[ -f "/tmp/v27_egrad_attn_12x1_d768_lr2e3_resume_\${LSB_JOBID}.yml" ] && rm -f "/tmp/v27_egrad_attn_12x1_d768_lr2e3_resume_\${LSB_JOBID}.yml"
