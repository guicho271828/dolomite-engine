#!/bin/bash
# v32_edesc_24x1_d1024_lr1e3: true EGrad/EDesc run (config bug fixed)

set -euo pipefail
REPO=/proj/dmfexp/nima/Code/dolomite-engine
CONFIG=/proj/dmfexp/nima/Code/dolomite-engine/configs/multi_block_ablation/v32_edesc_24x1_d1024_lr1e3.yml
SAVE_PATH=/proj/dmfexp/nima/Code/dolomite-engine/experiments/energy-inference/results/multi-block-ablation/v32_edesc_24x1_d1024_lr1e3
SCRIPT_PATH=/proj/dmfexp/nima/Code/dolomite-engine/experiments/energy-inference/scripts/multi-block-ablation/run_v32_edesc_24x1_d1024_lr1e3.sh
JOB_NAME=egptv32
...
if [ -f "\${LATEST_JSON}" ]; then
    ...
    TMPCONFIG="/tmp/v32_edesc_24x1_d1024_lr1e3_resume_\${LSB_JOBID}.yml"
    cp "\${CONFIG}" "\${TMPCONFIG}"
...
[ -f "/tmp/v32_edesc_24x1_d1024_lr1e3_resume_\${LSB_JOBID}.yml" ] && rm -f "/tmp/v32_edesc_24x1_d1024_lr1e3_resume_\${LSB_JOBID}.yml"
