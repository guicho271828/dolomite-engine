#!/bin/bash
# v33_egrad_attn_6x2_d1024_lr1e3: true EGrad/EDesc run (config bug fixed)

set -euo pipefail
REPO=/proj/dmfexp/nima/Code/dolomite-engine
CONFIG=/proj/dmfexp/nima/Code/dolomite-engine/configs/multi_block_ablation/v33_egrad_attn_6x2_d1024_lr1e3.yml
SAVE_PATH=/proj/dmfexp/nima/Code/dolomite-engine/experiments/energy-inference/results/multi-block-ablation/v33_egrad_attn_6x2_d1024_lr1e3
SCRIPT_PATH=/proj/dmfexp/nima/Code/dolomite-engine/experiments/energy-inference/scripts/multi-block-ablation/run_v33_egrad_attn_6x2_d1024_lr1e3.sh
JOB_NAME=egptv33
...
if [ -f "\${LATEST_JSON}" ]; then
    ...
    TMPCONFIG="/tmp/v33_egrad_attn_6x2_d1024_lr1e3_resume_\${LSB_JOBID}.yml"
    cp "\${CONFIG}" "\${TMPCONFIG}"
...
[ -f "/tmp/v33_egrad_attn_6x2_d1024_lr1e3_resume_\${LSB_JOBID}.yml" ] && rm -f "/tmp/v33_egrad_attn_6x2_d1024_lr1e3_resume_\${LSB_JOBID}.yml"
